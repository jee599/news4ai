# News4AI — AI 뉴스 자동화 플랫폼 기획서

> jidonglab.com의 AI 뉴스 파이프라인을 이메일 뉴스레터 + 실시간 크롤링 + 모바일 앱으로 확장한다.
> 핵심 원칙: **내가 개입하지 않는 완전 자동화**.
>
> 관련 문서: [회의록](MEETING-NOTES.md)

## 미결정 사항 (Owner: jidong)

- **서비스 형태:** jidonglab.com 확장 vs news4ai 독립 도메인 vs 하이브리드
- **수익 모델:** 무료 포트폴리오 vs 유료 프리미엄 vs 스폰서십
- **언어:** 한국어 vs 영어 vs 이중 언어
